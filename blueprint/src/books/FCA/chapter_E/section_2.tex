...
\begin{corollary}\label{cor:FCA-chapE-2.1.3}
...
\begin{theorem}\label{thm:FCA-chapE-2.2.1}
...
\begin{theorem}\label{thm:FCA-chapE-2.2.3}
...
\begin{theorem}\label{thm:FCA-chapE-2.3.1}
...
\begin{theorem}\label{thm:FCA-chapE-2.3.2}
...
\begin{theorem}\label{thm:FCA-chapE-2.4.1}
...
\begin{theorem}\label{thm:FCA-chapE-2.4.4}
...
\begin{theorem}\label{thm:FCA-chapE-2.5.1}
