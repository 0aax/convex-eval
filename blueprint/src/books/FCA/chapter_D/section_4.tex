...
\begin{corollary}\label{thm:4.3.2}
...
\begin{corollary}\label{cor:4.4.4}
...
\begin{itemize}
\item for each $x\in\mathbb{R}^n$, $g(x,\cdot)$ is upper semi-continuous;
\item for each $y\in Y$, $g(\cdot,y)$ is convex and differentiable;
\item the function $f:=\sup_{y\in Y} g(\cdot,y)$ is finite-valued on $\mathbb{R}^n$;
\item at some $x\in\mathbb{R}^n$, $g(x,\cdot)$ is maximized at a unique $y(x)\in Y$.
\end{itemize}
