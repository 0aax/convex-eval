...
\begin{corollary}[Strict Separation of Convex Sets]
\label{cor:CAMA-chap3-4.1.3}
\lean{CAMA_chap_3_4_1_3}
...
\begin{theorem}[Proper Separation of Convex Sets]
\label{thm:CAMA-chap3-4.1.4}
\lean{CAMA_chap_3_4_1_4}
...
\begin{definition}[Polyhedral Sets]\label{def:CAMA-chap3-4.2.6}
...
\begin{lemma}[Farkas I]
\label{lem:CAMA-chap3-4.3.1}
\lean{CAMA_chap_3_4_3_1}
...
\begin{theorem}[Generalized Farkas]
